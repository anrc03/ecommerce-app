...
public class JwtUtil {
    ...
    @Value("${app.springboot_shopeymarth_customer.jwt.jwt-secret}")
    private String jwtSecret;

    @Value("${app.springboot_shopeymarth_customer.jwt.app-name}")
    private String appName;

    @Value("${app.springboot_shopeymarth_customer.jwt.jwtExpirationInSecond}")
